                    ...
                    foreach($files as $key => $val){
                        if($val != null){
                            if($val['fileimg']->getClientFilename() != ''){
                                ...
                                NewsService::updateNewsPictureData($News->NewsID, $PicturePath);
                    ...
                    foreach($attachFileList as $key => $val){
                        if($val != null){
                            if($val['attachFile']->getClientFilename() != ''){
                                ...
                                NewsService::updateNewsAttachFile($News->NewsID, $newFileName, $AttachPath, $AttachFileType, $AttachFileSize, $AttachRealFileName);
